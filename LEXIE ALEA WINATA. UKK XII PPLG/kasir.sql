...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2026 at 08:34 AM
...
(1, 'lexie', 'jl ronggowarsito', '087897054474'),
(2, 'faiz', 'sm amin', '089787665'),
(3, 'ersad', 'jl sepakat', '0897867485'),
(4, 'raditya anto', 'Jl Harapan Raya', '0875383243'),
(5, 'maul', 'jl ronggowarsito', '123123123'),
(6, 'fakhri coder', 'jl gobah ', '08286975874');
...
(5, '2026-02-10', 28000000.00, 5),
(6, '2026-02-10', 100000.00, 6);
...
(2, 'Gamker DPIB', 20000.00, 3000),
(3, 'Iphone 17 Pro Max 2TB Casing Rimowa', 28000000.00, 13),
(4, 'Baju Keren', 100000.00, 0);
...
(1, 'lexie7ganteng', 'lexie7ganteng', 'admin'),
(2, 'petugas1', 'petugas1', 'petugas'),
(3, 'smkn2official', 'smkn2official', 'admin'),
(4, 'BukMeriSkom', 'BukMeriSkom', 'petugas');
